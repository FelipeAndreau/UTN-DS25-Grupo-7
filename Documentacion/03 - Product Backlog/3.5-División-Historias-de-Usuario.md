...
| Codigo   | Historia                                                                                     | Tipo de division                  |
|----------|-----------------------------------------------------------------------------------------------|-----------------------------------|
| HU-06.1  | Como vendedor, quiero ver la opción de eliminar en la lista de vehículos disponibles               | Entrada de datos                  |
| HU-06.2  | Como sistema, quiero confirmar la eliminacion antes de borrar definitivamente.                     | Regla de negocio                  |
| HU-06.3  | Como sistema, quiero eliminar al vehículo y mostrar un mensaje de exito.                          | Persistencia                      |
...
### Historia original
Como cliente, quiero buscar vehiculos por marca para encontrar opciones de mi interes.
...
### Historia original
Como cliente, quiero buscar vehiculos por modelo especifico para facilitar la comparacion.
...
### Historia original
Como cliente, quiero poder reservar un vehiculo para asegurarme prioridad.
...
### Historia original
Como cliente, quiero poder cancelar una reserva vigente.
